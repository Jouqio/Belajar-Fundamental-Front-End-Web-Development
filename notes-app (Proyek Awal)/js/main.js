/**
 * main.js
 * Titik masuk (entry point) aplikasi. Murni JavaScript, tanpa framework.
 *
 * Tanggung jawabnya:
 *  1. Mendaftarkan semua Web Component (Kriteria Wajib 4).
 *  2. Mengambil data dummy awal & menampilkannya (Kriteria Wajib 1).
...
/** Merender ulang seluruh tampilan daftar catatan berdasarkan data terbaru. */
...
function renderNotesInto(container, notes, emptyMessage) {
  ...
  notes.forEach((note) => {
    ...
    noteElement.note = note; // kirim data lewat properti, karena berupa object
